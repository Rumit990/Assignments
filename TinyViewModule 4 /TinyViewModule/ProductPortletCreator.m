...
@synthesize productPortletCreatorDelegate;
@synthesize shoppingItem;


-(void)shortlistButtonPressed
{
    
    NSLog(@"Yahaan button pressed event toh catch ho rahaa hai$$$$$$$$$$$$$$$$$$$$$$$$");
    [self.productPortletCreatorDelegate shortlistButtonHandler:self.shoppingItem];
}


-(void)buyButtonPressed
{
    [self.productPortletCreatorDelegate buyButtonHandler:self.shoppingItem];
}
...
-(void)createUI
{
    ...
    [self.shortlistButton addTarget:self action:@selector(shortlistButtonPressed) forControlEvents:UIControlEventTouchUpInside];
