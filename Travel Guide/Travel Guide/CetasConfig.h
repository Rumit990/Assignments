 ...
 *  @code
    ...
    [config setUserLatitude:location.coordinate.latitude
 ...
 *  @code
 ...
 //Create Config object and set user location.
 Config *config = [[Config alloc] init];
 [config setUserCarrierName:ctCarrier.carrierName mobileCode:ctCarrier.mobileCountryCode mobileNetworkCode:ctCarrier.mobileNetworkCode isoCountryCode:ctCarrier.isoCountryCode];
